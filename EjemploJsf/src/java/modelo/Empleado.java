...
public class Empleado implements Serializable {
    ...
    @JoinColumn(name = "id_depar_emp", referencedColumnName = "id_depar")
    @ManyToOne(optional = false)
    private Departamento idDeparEmp;
    ...
    public Departamento getIdDeparEmp() {
        return idDeparEmp;
    }

    public void setIdDeparEmp(Departamento idDeparEmp) {
        this.idDeparEmp = idDeparEmp;
    }
